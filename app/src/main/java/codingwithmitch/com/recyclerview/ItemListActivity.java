...
import codingwithmitch.com.recyclerview.dummy.DummyContent;
...
public class ItemListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mContentView.setText(mValues.get(position).intro);
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View view) {
                super(view);
                mIdView = (TextView) view.findViewById(R.id.image_name);
                mContentView = (TextView) view.findViewById(R.id.intro);
            }
        }
    }
